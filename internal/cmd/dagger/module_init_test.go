...
func TestSDKResolve(t *testing.T) {
	for _, tt := range []struct {
		...
		},
		{
			...
			input: "go-sdk",
			want:  "github.com/dagger/go-sdk@adf60252445825c0d1fa2849f69eefe230d7f154",
		},
		{
		...
		},
		{
			name:  "python alias",
			input: "py",
			want:  "github.com/dagger/python-sdk@da2ed282fd1cffda8a5ef7242b2aa562182b5e4f",
		},
		{
			name:  "typescript alias",
			input: "ts",
			want:  "github.com/dagger/typescript-sdk@19dd24aabefaf25f49e21a232eb5b72103627cea",
		},
		{
			name:  "dang bundled sdk",
			input: "dang",
			want:  "github.com/dagger/dang-sdk@a21728f312f3595e067b715d2a93ec4dbb16fb88",
		},
		{
...
func TestSDKResolveInstall(t *testing.T) {
	for _, tt := range []struct {
	...
	}{
		{
			...
			input:           "go",
			wantRef:         "github.com/dagger/go-sdk@adf60252445825c0d1fa2849f69eefe230d7f154",
		...
		},
		{
			...
			input:           "dang",
			wantRef:         "github.com/dagger/dang-sdk@a21728f312f3595e067b715d2a93ec4dbb16fb88",
